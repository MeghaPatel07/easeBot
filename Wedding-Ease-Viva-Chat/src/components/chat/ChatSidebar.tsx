...
const ChatSidebar: React.FC<ChatSidebarProps> = ({
  ...
  return (
    <>
      ...
      <aside aria-label="Chat history sidebar" className={`fixed left-0 top-0 h-full transition-all duration-300 z-30 font-body ${isOpen ? 'w-64' : 'w-0'} overflow-hidden`} style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
