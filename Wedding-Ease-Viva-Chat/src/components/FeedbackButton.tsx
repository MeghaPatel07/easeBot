  ...
  return (
    <>
      <button
        ...
        className={
          className ??
          'w-full flex items-center gap-3 px-2.5 py-2 rounded-xl transition-all duration-200 text-xs text-foreground/55 hover:text-foreground/90 hover:bg-foreground/[0.05]'
        }
      >
