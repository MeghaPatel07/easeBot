            ...
            <tr className="bg-background">
              {headers.map((header, colIdx) => (
                <th
                  ...
                  className="px-2 sm:px-3 py-2 text-xs font-semibold text-stone-700 cursor-pointer select-none whitespace-nowrap"
                >
              ...
              >
                {row.map((cell, colIdx) => {
                  ...
                  return (
                    <td
                      key={colIdx}
                      className={`px-2 sm:px-3 py-2 text-xs sm:text-sm text-stone-600 ${
                        highlighted
