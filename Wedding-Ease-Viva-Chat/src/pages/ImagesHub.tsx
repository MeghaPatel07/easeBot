  ...
  return (
    <main className="mx-auto max-w-6xl space-y-6 px-4 pt-6 pb-2 sm:px-6">
      ...
      {user ? (
                    ...
                    return (
                      <button
                        ...
                        className={`inline-flex items-center gap-1.5 rounded-full border px-3 py-1.5 text-xs font-medium backdrop-blur-md transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 ${
                          active
                            ? 'border-foreground/30 bg-foreground/[0.14] text-foreground shadow-sm'
                            : 'border-foreground/15 bg-foreground/[0.06] text-foreground/60 hover:border-foreground/25 hover:bg-foreground/[0.1] hover:text-foreground'
                        }`}
                      >
                        <span
                          aria-hidden="true"
        ...
        <div className="rounded-2xl bg-foreground/[0.04] p-5 text-center shadow-lg shadow-black/10 backdrop-blur-xl">
