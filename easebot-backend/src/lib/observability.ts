...
export type ObservabilityEvent =
  ...
  | 'payment.razorpay.order_mismatch'
  | 'payment.razorpay.signature_mismatch'
  | 'payment.razorpay.webhook_signature_mismatch'
  | 'payment.razorpay.webhook_unmapped'
  | 'payment.razorpay.amount_mismatch'
