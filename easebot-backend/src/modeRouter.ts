...
const MODE_PATTERNS: Array<{ mode: Mode; patterns: RegExp[] }> = [
  ...
  },
  {
    mode: 'stylist',
    patterns: [
      /\b(dress|gown|suit|tux|tuxedo|veil|flowers|floral|bouquet|centerpiece|décor|decor|color|colour|palette|aesthetic|theme|style|mood.?board|inspiration|look|vibe|bohemian|rustic|modern|romantic|vintage|glamour|bridesmaid|groomsmen|attire|outfit|fashion|accessor(?:y|ies)|jewelry|jewellery|jewelery)\b/i,
